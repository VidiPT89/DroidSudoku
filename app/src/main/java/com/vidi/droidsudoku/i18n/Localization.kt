    ...
    companion object {
        private val strings: Map<Lang, Map<String, String>> = mapOf(
            Lang.PT to mapOf(
                ...
                "challengesTitle" to "Desafios",
                "challengesSubtitle" to "Sobe nível a nível. Cada um mais difícil que o anterior.",
                "level" to "Nível",
                "locked" to "Bloqueado",
                "levelReached" to "Nível",
                "starsLabel" to "Estrelas",
                "showEarlier" to "Ver níveis anteriores",
                "nextLevel" to "Próximo Nível",
                "backToLevels" to "Voltar aos Níveis",
                "levelUnlocked" to "Novo nível desbloqueado!",
                "levelCompleteSuffix" to "Completo!",
            ...
            Lang.EN to mapOf(
                ...
                "challengesTitle" to "Challenges",
                "challengesSubtitle" to "Climb level by level. Each one harder than the last.",
                "level" to "Level",
                "locked" to "Locked",
                "levelReached" to "Level",
                "starsLabel" to "Stars",
                "showEarlier" to "Show earlier levels",
                "nextLevel" to "Next Level",
                "backToLevels" to "Back to Levels",
                "levelUnlocked" to "New level unlocked!",
                "levelCompleteSuffix" to "Complete!",
